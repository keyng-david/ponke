    ...
    <div className={className}>
        <svg className={styles.main} width="231" height="189" viewBox="0 0 231 189" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
                ...
                stroke="#060000" stroke-width="1.2"/>
            <defs>
...
const MonitorCenterScreen = () => (
    <svg width="196" height="122" y="22" x="12" viewBox="0 0 200 125" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            fill="url(#paint0_linear_25_4716)" stroke="#060000" stroke-width="2"/>
        <path
            id={'path2-center'}
            d="M2 4.20359L14.5 123.289C69.0401 119.918 174.358 116.477 198 118.789C198.24 90.2631 199.109 14.816 187 1.789C128.616 0.34416 13.5327 0.735979 2 4.20359Z"
            stroke="#060000" stroke-width="2"/>
        <path
            ...
            stroke="#37363A" stroke-width="3" stroke-linecap="round"/>
        <path
            id={'path4-center'}
